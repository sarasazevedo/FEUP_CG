...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'showQuad').name('Quad');
        this.gui.add(this.scene, 'hideMaterial').name('Hide Material');
        this.gui.add(this.scene, 'showTangram').name('Tangram');
        this.gui.add(this.scene, 'showMineCube').name('Mine Cube');
