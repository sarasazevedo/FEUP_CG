...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        // Create cube with mine textures (top, bottom, front, right, back, left)
        this.unitCubeQuad = new MyUnitCubeQuad(
            this, 
            this.textureMineTop,      // top (+Y)
            this.textureMineBottom,   // bottom (-Y)
            this.textureMineSide,     // front (+Z)
            this.textureMineSide,     // right (+X)
            this.textureMineSide,     // back (-Z)
            this.textureMineSide      // left (-X)
        );
    ...
    initCameras() {
        this.camera = new CGFcamera(0.43, 0.1, 500, vec3.fromValues(0, 30, 40), vec3.fromValues(0, 10, 0));
    }
    ...
    display() {
        ...
        // ---- BEGIN Primitive drawing section for Quad
